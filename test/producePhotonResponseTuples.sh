...
setups=(
    ...
    CloseByParticleGunProducer_realisticStartup_20201127,useVanillaCfg=False,byDoseAlgo=1
    #    CloseByParticleGunProducer_realisticStartup_20201123,useVanillaCfg=False,byDoseAlgo=1
    #CloseByParticleGunProducer_aged3iab_20201127,useVanillaCfg=False,byDoseAlgo=0
